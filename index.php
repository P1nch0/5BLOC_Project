...
<!-- fevicon -->
<link rel="icon" href="images/fraktal_icon.png" type="image/gif" />
      ...
      <div class="col-md-6"> 
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active"> <img class="first-slide" src="images/fraktal.png" alt="First slide"> </div>
      ...
      <div class="col-md-6">
        <div class="full-slider_cont">
          <h1>World ‘s popular<br>
            <span class="dark_brown">Fraktal company</span></h1>
	    ...
	    it look like readable English. Many desktop publishing packages and</p>
          <div class="button_section"> <a class="main_bt" href="Exchange.php">Exchange</a> <a class="main_bt" href="aboutus.php">About Us</a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
        <div class="service-box">
          <h2>our <strong class="cur">services</strong></h2>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage2">
          <h2>our <strong class="cur">Team</strong></h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
          <div class="experts-threebox">
            <figure><img src="images/pp_dorian.jpg" alt="img"/></figure>
            <h3>Dorian Ruiz </h3>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
          <div class="experts-threebox">
            <figure><img src="images/pp_oussama.jpg" alt="img"/></figure>
            <h3>Oussama Moussaoui</h3>
            <span>Director</span>
            <p>exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor</p>
            <div class="icon"> <i> <a href="#"><img src="images/facebook.png"></a></i> <i> <a href="#"><img src="images/Twitter.png"></a></i> <i> <a href="#"><img src="images/linkedin.png"></a></i> <i> <a href="#"><img src="images/instagram.png"></a></i> </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
          <div class="experts-threebox">
            <figure><img src="images/pp_mustafa.jpg" alt="img"/></figure>
            <h3>Mustafa Altinbasak </h3>
